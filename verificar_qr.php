    ...
    if ($conn->query($sql_insert) === TRUE) {
        ...
        function enviarCorreo($correo_tutor, $usuario, $nombre, $entrada)
        {
            ...
            try {
                ...
                $mail->Body    = 'ASISTENCIAL DEL USUARIO ' . $usuario . '<br> Buenas, señor padre o madre del usuario ' . $usuario . ', se le informa que el ingreso a la institucion de ' . $nombre . ' fue el día y hora señalados a continuación: ' . $entrada . '';
                $mail->send();
